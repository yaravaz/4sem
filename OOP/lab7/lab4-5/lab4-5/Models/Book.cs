...
namespace lab4_5
{
    public partial class Book : INotifyPropertyChanged
    {
        ...
        public Book(int productCode, string pName, string pAuthor, double price, double rating, string pImage, string pDescription, short isActive, string bookCategory, int bookGenre)
        {
        ...
        public object Clone()
        {
            return new Book(ProductCode, PName, PAuthor, Price, Rating, PImage, PDescription, isActive, BookCategory, BookGenre);
        }
    }
}
